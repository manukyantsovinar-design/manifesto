...
function shell(bodyHtml) {
  ...
  <div style="background:#E9F4FF;padding:40px 16px;font-family:Georgia,'Times New Roman',serif;">
    <div style="max-width:480px;margin:0 auto;background:#F6F0E4;border-radius:6px;padding:40px 36px;box-shadow:0 10px 30px rgba(64,45,43,0.12);">
      ...
      <p style="margin:0 0 4px;font-size:13px;letter-spacing:0.06em;text-align:center;"><a href="https://www.instagram.com/tsovinnar_/" style="color:rgba(15,60,102,0.6);text-decoration:none;">Manifesto by Tsovinar Manukyan</a></p>
      ${bodyHtml}
      <p style="margin:24px 0 0;font-size:10px;line-height:1.5;color:rgba(64,45,43,0.45);text-align:center;">This is an automated message. Please don&rsquo;t reply.</p>
    </div>
  </div>`;
}
...
function confirmationEmailHtml({ name, sealedUrl }) {
  return shell(`
    ...
    <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#402D2B;text-align:center;">It&rsquo;s kept safe. In about 30 days a note will land here with three small questions and a link back to it. This email is just so you always have that link, even if you lose the tab.</p>
